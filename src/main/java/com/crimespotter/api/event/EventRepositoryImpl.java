...
public class EventRepositoryImpl implements EventRepository {
    ...
    @Override
    public void addCrime(String event_id, String suspect_description, String crime_type) {
        String query =
    ...
    @Override
    public void addNaturalDisaster(String event_id, String type, Integer magnitude) {
        String query =
    ...
    @Override
    public void addCarAccident(String event_id, String collision_type, Integer pedestrians_involved, String license, String make, String model, String colour) {
